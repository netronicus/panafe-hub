...
export function PanaFeLink(): JSX.Element {
    ...
    <>
      <span className="relative inline">
        <button
          ...
          className="inline text-blue-600 underline decoration-dotted underline-offset-2 hover:text-blue-800 cursor-pointer bg-transparent border-none p-0 font-inherit"
        ...
        {showTooltip && (
          <span
            className="hidden sm:block absolute left-1/2 -translate-x-1/2 bottom-full mb-2 px-3 py-1.5 bg-gray-900 text-white text-xs rounded-lg whitespace-nowrap z-50 shadow-lg"
            role="tooltip"
          >
